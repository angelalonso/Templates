...
: ${AMENT_CURRENT_PREFIX:="/home/aaf/Software/Dev/robot/test/first_package/install/first_package"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/first_package/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/first_package/environment/path.sh"
